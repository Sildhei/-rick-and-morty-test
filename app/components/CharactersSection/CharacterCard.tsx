...
const CharacterCard = ({ character, selectedCharacters, index }: CharacterProps) => {
  ...
  return (
    <div className='max-w-[300px] flex flex-col lg:flex-row rounded-md relative group'>
      ...
      <div className='w-[150px] h-[100px] rounded-t-md lg:w-[100px] lg:h-[120px] lg:rounded-l-md relative overflow-hidden'>
        <Image
          src={character.image}
          alt={character.name}
          fill
      ...
      <div
        ...
        } ${!isDisabled && 'lg:group-hover:bg-primary'} rounded-b-md lg:rounded-r-md transition-all`}>
        <p
