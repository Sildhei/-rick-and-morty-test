    ...
    <div className='flex flex-row items-center justify-center gap-6 my-6 w-full md:w-[350px] border-[1px] border-gray-800 rounded-md p-1 mx-auto'>
      <button
        ...
        <svg
          ...
          viewBox='0 0 24 24'
          fill='none'
          className={`${Number(page) !== 1 ? 'stroke-gray-800' : 'stroke-gray-400'} ${
            Number(page) !== 1 && ' lg:hover:stroke-green-500'
          }`}>
          <path
      ...
      <button
        ...
        className={`text-lg ${Number(page) !== 1 ? 'text-gray-800' : 'text-gray-400'} ${
          Number(page) !== 1 && 'lg:hover:text-green-500'
      ...
      <button
        ...
        className={`text-lg ${Number(page) !== totalPages ? 'text-gray-800' : 'text-gray-400'} ${
          Number(page) !== totalPages && 'lg:hover:text-green-500'
      ...
      <button
        ...
        <svg
          ...
          viewBox='0 0 24 24'
          fill='none'
          className={`${Number(page) !== totalPages ? 'stroke-gray-800' : 'stroke-gray-400'} ${
            Number(page) !== totalPages && ' lg:hover:stroke-green-500'
          }`}>
          <path
